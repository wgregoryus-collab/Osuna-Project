Function:OnPlayerFakeKill(playerid, spoofedid, spoofedreason, faketype)
{ 
...
Function:OnPlayerFakeConnect(playerid)
{ 
...
Function:OnPlayerJetpackCheat(playerid)
{ 
...
Function:OnPlayerSpamChat(playerid)
{ 
...
Function:OnPlayerGunCheat(playerid, weaponid, ammo, hacktype)
{ 
...
Function:OnPlayerSpeedCheat(playerid, speedtype)
{ 
...
Function:OnPlayerBreakAir(playerid, breaktype)
{ 
...
Function:OnPlayerSpamCars(playerid, number)
{ 
...
/*Function:OnPlayerCarTroll(playerid, vehicleid, trolledid, trolltype)
{ 
...
Function:OnPlayerCarSwing(playerid, vehicleid)
{ 
...
Function:OnPlayerParticleSpam(playerid, vehicleid)
{ 
...
Function:OnVehicleModEx(playerid, vehicleid, componentid, illegal)
{ 
    if(illegal) 
    { 
...
Function:OnPlayerSlide(playerid, weaponid, Float:speed)
{ 
...
Function:OnPlayerBugAttempt(playerid, bugcode)
{ 
